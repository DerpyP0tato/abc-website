      ...
      <section className="pt-6 pb-20 sm:pt-12 sm:pb-24">
        <div className="mx-auto max-w-7xl px-8 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-stretch mb-24">
            <div className="bg-slate-50 rounded-3xl p-8 sm:p-12 border border-slate-100 flex flex-col justify-center">
              <h2 className="font-serif text-3xl font-bold text-slate-900 mb-4">{content.missionTitle}</h2>
            ...
            <div className="space-y-8">
              <div>
                <h2 className="font-serif text-3xl font-bold text-slate-900 mb-4">{content.whyTitle}</h2>
                <p className="text-lg leading-relaxed text-slate-600">
                  {content.whyContent}
                </p>
              </div>
              <div>
                <h2 className="font-serif text-3xl font-bold text-slate-900 mb-4">{content.whoTitle}</h2>
                <p className="text-lg leading-relaxed text-slate-600">
                  {content.whoContent}
                </p>
              </div>
          ...
          {/* Founding Story */}
          <div className="mb-24 rounded-3xl bg-white p-8 sm:p-12 border border-slate-100 shadow-sm relative overflow-hidden">
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-2 lg:gap-12 items-center">
              <div>
                ...
                <h2 className="font-serif text-3xl font-bold text-slate-900 mb-6">{content.foundingTitle}</h2>
          ...
          <div className="mb-24">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="font-serif text-3xl font-bold text-slate-900 sm:text-4xl">{content.offeringsTitle}</h2>
          ...
          <div className="rounded-[2.5rem] bg-blue-50 px-6 py-16 sm:px-12 sm:py-24 text-center relative overflow-hidden border border-blue-100">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="font-serif text-3xl font-bold text-blue-900 sm:text-4xl">{content.ctaTitle}</h2>
